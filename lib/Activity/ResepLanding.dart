    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Text("Kreasikan bahan baku Anda", style: TextStyle(color: Colors.black,fontFamily: "Poppins", fontSize: 18.sp, fontWeight: FontWeight.bold  ),),
          Padding(
            padding: EdgeInsets.all(5.dm),
            child: Text("Butuh ide untuk hidangan selanjutnya? Dapatkan resep yang tepat sesuai selera dan bahan baku Anda",textAlign: TextAlign.center ,style: TextStyle(color: Colors.grey,fontFamily: "Poppins", fontSize: 14.sp, fontWeight: FontWeight.normal  ),),
          ),
