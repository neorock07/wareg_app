...
class _OnMapState extends State<OnMap> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder<GeoPoint>(
            stream: stream_controller!.stream,
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                GeoPoint user_current = snapshot.data!;
              }
              return Stack(
                children: [
                  Container(
                      ...
                      child: MapBox(context, mpController.controller, koordinat,
                          isDraw: true, stream_controller: stream_controller)),
                  DraggableScrollableSheet(
                      ...
                      builder: ((context, scrollController) {
                        return Container(
                          color: Colors.white,
                          child: (mpController.latitude == null &&
                                  mpController.longtitude == null)
                              ? Center(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => CardButton(context, isPressed,
                                    onTap: (_) async {
                                  ...
                                  roadInfo = await mpController.controller
                                      .drawRoad(
                                          GeoPoint(
                                              latitude: lat_user!,
                                              longitude: long_user!),
                                          ...
                                          roadOption: RoadOption(
                                              roadColor: Color.fromRGBO(
                                                  42, 122, 89, 1),
                                              roadBorderColor: Color.fromRGBO(
                                                  42, 122, 89, 1),
                                              zoomInto: true,
                                              roadWidth: 10));
                                  print(
                                      "Jarak : ${roadInfo!.distance! * 1000} m");
